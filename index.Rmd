...
```{r}
data |>
ggplot(mapping = aes(x = corrupti, y = constch_overall)) + geom_point() + labs (title = "Number of Constitutional Changes by Corruption Level", y = "Number of Constitutional Changes", x = "Corruption Level") + scale_x_reverse() + scale_x_continuous(breaks = c(0,1,2,3,4,5,6), labels = c("6 (Least Corrupt)", "5","4","3","2","1","0 (Most Corrupt)"))
